...
def train_model():
    ...
    if not os.path.exists('../compare_models/methods/UNet_1D/outputs'):
        os.makedirs('../compare_models/methods/UNet_1D/outputs')
    torch.save(model.state_dict(), '../compare_models/methods/UNet_1D/outputs/unet_model.pth')
    print(" 학습 완료!")
